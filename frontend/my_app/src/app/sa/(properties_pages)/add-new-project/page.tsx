...
export default function AddNewProjectPage() {
   ...
   // getCountryCitiesList - send id of selected country to get cities list
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("hand_over_year", handOverYear);
                    ...
                    <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 mb-1.5">Units <span className="text-red-500">*</span></label>
                                        <input
                                            name="units"
                                            type="number"
                                            step="1"
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center text-center">
                                    <svg className="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-3-3v6"/></svg>
                                </div>
                                <h2 className="text-lg font-semibold text-slate-800">Status Details</h2>
                            </div>
                            {/* Hand Over Year & Quarter */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {/* Hand Over Year */}
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1.5">Hand Over Year <span className="text-red-500">*</span></label>
                                <input
                                name="hand_over_year"
                                type="date"
                                value={handOverYear}
                                onChange={onChangeHandOverYear}
                                className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-white text-slate-900 placeholder-slate-400"
                                />
                            </div>
                            {/* Hand Over Quarter */}
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1.5">Hand Over Quarter <span className="text-red-500">*</span></label>
                                <select
                                name="hand_over_year_quarter"
                                value={handOverYearQuarter}
                                onChange={onChangeHandOverYearQuarter}
                                className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-white text-slate-900 appearance-none cursor-pointer"
                                >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1.5">Status Details <span className="text-red-500">*</span></label>
                                <select
                                name="status_detail"
                                value={statusDetails}
                                onChange={onChangeStatusDetails}
                                className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-white text-slate-900 appearance-none cursor-pointer"
                                >
