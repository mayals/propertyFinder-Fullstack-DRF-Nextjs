...
import { addAmenity } from "../../utils/property";
...
export default function AddAmenity() {
    ...
    // AddAmenity form field
    const [amenityName, setAmenityName] = useState('');
     
   
    
    useEffect(() => {
        console.log("AddAmenity-loading=",loading)
        console.log("AddAmenity-user=",user)
    ...
    const onChangeAmenityName = (e) => {
        setAmenityName(e.target.value)
        console.log('onChange CountryName=', e.target.value)
    }
    ...
    const handleSubmit = async (e) => {
        ...
        if (!amenityName) {     
            notify("Please enter the Amenity Name !","warning");
            return;
        }
        ...
        try { 
            ...
            notify("The amenity has been add successfully", "success");
            ...
            console.log("addAmenity error =", error);
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                      ...
                      <li>
                        <div className="flex items-center">
                          ...
                          <a href="/my-dashboard" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">My Dashboard</a>
                        </div>
                      </li>
                      <li aria-current="page">
                        <div className="flex items-center">
                          ...
                          <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Add Country</span>
                        </div>
                      </li>
                    </ol>
                  </nav> 
