...
import { getCountriesList, addCity} from "../../utils/property";
...
export default function AddCities() {
    ...
    useEffect(() => {
        console.log("AddCity-loading=",loading)
        console.log("AddCity-user=",user)
    ...
    const onChangeSelectedCountry = (e) => {
        ...
        console.log("onChangeSelectedCountry id =", e.target.value);
    };

    const onChangeCityName = (e) => {
        setCityName(e.target.value)
        console.log('onChangeCityName =', e.target.value)
    }
    ...
    const handleSubmit = async (e) => {
        ...
        if (!selectedCountry) {
            notify("Please select the Country !","warning");
            return;
        }
        if (!cityName) {     
            notify("Please enter the City Name !","warning");
            return;
        }
       
        // addCity - axios //
        try { 
              await addCity(selectedCountry, cityName)
              notify("The city has been add successfully", "success");
