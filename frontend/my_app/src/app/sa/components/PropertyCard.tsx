        ...
        > */}
          ...
          <div className="rounded-b-lg bottom-0 left-0 right-0 bg-[#e5e7eb] text-gray-500 text-xs px-3 py-1 flex justify-between items-center">
              ...
              <div className="flex gap-2 text-lg items-center">
                <button className="bg-white text-[#5842f6] text-center border-1 border-[#5842f6] rounded-md flex items-center py-2 px-3">
                  <FiPhone className="text-[#5842f6]" />
                  <span className="ml-2 text-[#5842f6]">Call</span>
                </button>
                <button className="bg-white text-[#5842f6] text-center border-1 border-[#5842f6] rounded-md flex items-center py-2 px-3">
                  <FiMail className="text-[#5842f6]" />
                  <span className="ml-2 text-[#5842f6]">Email</span>
                </button>
                <button className="bg-white text-[#5842f6] text-center border-1 border-[#5842f6] rounded-md flex items-center py-2 px-3">
                  <FiMessageCircle className="text-[#5842f6]" />
                  <span className="ml-2 text-[#5842f6]">Whatsapp</span>
                </button>
