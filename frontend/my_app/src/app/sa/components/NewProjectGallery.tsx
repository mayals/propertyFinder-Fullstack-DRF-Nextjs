...
export default function NewProjectGallery({ images }: { images: ImageObj[] }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 relative bg-white p-1 rounded-lg shadow">
      {/* Main Image */}
