// (dynamic_pages)/(properities_pages)/components/Find.tsx
"use client";
...
export default function Find({purpose, mainType}) {
        ...
        >
                ...
                <div className="relative">
                        ...
                        <div className="fixed inset-0 z-40 min-h-full overflow-y-auto overflow-x-hidden transition flex items-center">
                            ...
                            {/* Modal  */}
                            <div className="relative my-auto p-4 w-[90vw] max-w-[800px] mx-auto">
