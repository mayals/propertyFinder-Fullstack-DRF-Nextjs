            ...
            <>
                <section className="mx-auto mt-10 mb-20 max-w-6xl text-center p-6 dark:bg-gray-900">
                    <h2 className="mb-12 text-center text-2xl text-gray-900">
                        <span className="text-[#c75a00] text-2xl">
                        {user?.first_name}&apos;s
                        </span>
                        &nbsp;Dashboard
                    </h2>
