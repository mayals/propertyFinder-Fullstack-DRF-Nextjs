            ...
            <>
                <section className="mx-auto mt-10 mb-20 max-w-6xl text-center p-6 dark:bg-gray-900">
                    ...
                    <div className="mx-auto max-w-3xl items-stretch space-y-4 text-left sm:flex sm:space-y-0 sm:space-x-8 sm:text-center">
                        ...
                        <Link href="/editProfile" className="flex w-full  md:flex md:flex-col  rounded-xl border border-black border-opacity-10 px-4 py-6 text-black duration-200 hover:border-opacity-0 hover:no-underline hover:shadow-lg  sm:hover:shadow-2xl">
