...
urlpatterns = [
    ...
    path('<uuid:projectId>/new-project-upload-videos/', views.CreateNewProjectVideoUploadAPIView.as_view(), name="create-new-project-upload-videos"),
    path('<uuid:projectId>/new-project-upload-documents/', views.CreateNewProjectDocumentUploadAPIView.as_view(), name="create-new-project-upload-documents"),
